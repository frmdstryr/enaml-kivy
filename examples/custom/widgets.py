...
SingleLineTextField = get_control("kivymd.textfields.SingleLineTextField")
MapView = get_control("kivy.garden.mapview.MapView",read_only_properties=['bbox'])
MapLayer = get_control("kivy.garden.mapview.MapLayer")
MapMarker = get_control("kivy.garden.mapview.MapMarker")
